...
export default function Projects() {
  ...
  // Use useMemo to only recompute filteredProjects when searchQuery changes
  const filteredProjects = useMemo(
    () => storeProjects.filter((project) => project.name.toLowerCase().includes(searchQuery.toLowerCase())),
    [searchQuery, storeProjects]
  );
