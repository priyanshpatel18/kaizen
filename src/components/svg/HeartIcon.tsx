...
export default function HeartIcon({ className = "", onClick, cancel = false }: HeartIconProps) {
  ...
  return cancel ? (
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M22 2L2 22" stroke={themeColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ) : (
    <svg
      width="22"
