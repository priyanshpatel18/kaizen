...
export default function InboxIcon({ active = false }: InboxIconProps) {
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2V8L14 6" stroke={themeColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 8L10 6" stroke={themeColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
